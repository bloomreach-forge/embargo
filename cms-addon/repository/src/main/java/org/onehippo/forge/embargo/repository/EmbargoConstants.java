...
public class EmbargoConstants {
    ...
    public static final String EMBARGO_GROUPS_MAPPING_NODE_PATH = "hippo:configuration/hippo:domains/embargo";
    public static final String EMBARGO_GROUPS_MAPPING_NODE_NAMES = "hipposys:authrole";
